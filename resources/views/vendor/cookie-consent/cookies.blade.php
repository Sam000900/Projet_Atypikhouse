            ...
            <form action="{{ route('cookieconsent.accept.configuration') }}" method="post" class="cookies__customize">
                ...
                <div class="cookies__sections">
                    ...
                    <div class="cookies__section">
                        ...
                        <a href="#cookies-policy-{{ $category->key() }}" class="cookies__details" style="color:#296242;">@lang('cookieConsent::cookies.details.more')</a>
                    </div>
                    @endforeach
                </div>
                <div class="cookies__save">
                    <button type="submit" class="cookiesBtn__link" style="background-color:#296242;border-color:#296242;">@lang('cookieConsent::cookies.save')</button>
                </div>
            </form>
        </div>
    </div>
